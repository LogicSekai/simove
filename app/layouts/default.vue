                    ...
                    <nav class="hidden justify-between lg:flex">
                        ...
                        <div class="flex items-center gap-2 mr-4">
                            <div class="relative w-full max-w-xs flex items-center">
                                ...
                                <input placeholder="Search..." class="bg-background w-full rounded-md border px-3 py-2 pr-10 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1" type="text" value="">
